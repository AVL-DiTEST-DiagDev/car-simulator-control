 ...
 * Date: 19.02.2018
 * Version: 0.0.1
 * Based on JSch Example "Shell"*/
/**
 * This program asks you for username, IP and password of the device you want to connect to.
 * After successful login it will open the devices shell, which is now remotable in the console.
 */
